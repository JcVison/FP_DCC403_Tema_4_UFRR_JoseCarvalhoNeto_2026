...
#
# Este fenômeno demonstra uma limitação da política FIFO, pois ela remove páginas apenas pela ordem de chegada, sem considerar se elas serão utilizadas novamente em breve.
#
# Validação
#
